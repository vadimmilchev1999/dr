const translations = {
  vi: {
    ...
    follow:
      "🥰 Hãy follow mình để cập nhật những website mới nhất, nhanh nhất nhé!",
    apply: "Áp Dụng Cài Đặt",
    copyright:
      'Website được tạo bởi tiktoker: <a href="https://www.tiktok.com/@iamtritoan?is_from_webapp=1&sender_device=pc" target="_blank"> @iamtritoan</a>',
    ...
    error: "❌ Có lỗi xảy ra!",
    invalidPage:
      "❌ Cấu trúc trang không hợp lệ! Hiện tại có {pages} trang. Vui lòng thêm hoặc xóa 1 trang để tạo cấu trúc hợp lệ.",
    ...
    free: "MIỄN PHÍ",
    thanks:
      "Cảm ơn bạn rất nhiều! Nếu thích sản phẩm này, hãy follow kênh TikTok <b>tớ là Toán</b> để mình có động lực ra nhiều sản phẩm hơn nhé!",
    ...
    pleaseAddOrRemovePage:
      "Vui lòng thêm thêm 1 trang hoặc xóa bớt 1 trang để tạo cấu trúc hợp lệ.",
    fullscreenNotSupported:
      "Trình duyệt của bạn không hỗ trợ chế độ toàn màn hình!",
    noteSequence:
    ...
    followNote:
      '🥰 Hãy <a href="https://www.tiktok.com/@iamtritoan?is_from_webapp=1&sender_device=pc" target="_blank" style="color:#ff0050;font-weight:bold;text-decoration:underline;">follow mình</a> để cập nhật những website mới nhất, nhanh nhất nhé!',
    on: "Bật",
    off: "Tắt",
    sec3: "3 giây",
    sec5: "5 giây",
    ...
    noGif: "Không có",
    notVietnamWarning:
      'Nếu gặp vấn đề hãy nhắn tin qua TikTok<a href="https://www.tiktok.com/@iamtritoan?is_from_webapp=1&sender_device=pc" target="_blank" style="color:#ff0050;font-weight:bold;text-decoration:underline;"> @iamtritoan</a> để được hỗ trợ.',
  ...
  en: {
    title: "Матурым Динара ❤️",
    description:
      "A special birthday wish just for you! Discover this meaningful gift!",
    ...
    follow:
      "🥰 Please follow me to get the latest websites as soon as possible!",
    apply: "Apply Settings",
    copyright:
      'Website created by tiktoker:<a href="https://www.tiktok.com/@iamtritoan?is_from_webapp=1&sender_device=pc" target="_blank"> @iamtritoan</a>',
    ...
    invalidPage:
      "❌ Invalid page structure! Currently {pages} pages. Please add or remove 1 page for valid structure.",
    ...
    free: "FREE",
    thanks:
      "Thank you so much! If you like this product, please follow my TikTok channel <b>tớ là Toán</b> to motivate me to make more!",
    ...
    pleaseAddOrRemovePage:
      "Please add or remove 1 page to create a valid structure.",
    fullscreenNotSupported: "Your browser does not support fullscreen mode!",
    // Thêm vào cả vi và en:
    noteSequence:
      "Note: Please separate words with | and don't make a line too long",
    noteExpire:
      "⏳ <b>Note:</b> The website is only valid for <b>30 days</b>, so don't create it too early!",
    followNote:
      '🥰 Please <a href="https://www.tiktok.com/@iamtritoan?is_from_webapp=1&sender_device=pc" target="_blank" style="color:#ff0050;font-weight:bold;text-decoration:underline;">follow me</a> to get the latest websites as soon as possible!',
    on: "On",
    off: "Off",
    sec3: "3 seconds",
    sec5: "5 seconds",
    ...
    noGif: "None",
    notVietnamWarning:
      'If you encounter any issues, please message me on TikTok<a href="https://www.tiktok.com/@iamtritoan?is_from_webapp=1&sender_device=pc" target="_blank" style="color:#ff0050;font-weight:bold;text-decoration:underline;"> @iamtritoan</a> for support.',
